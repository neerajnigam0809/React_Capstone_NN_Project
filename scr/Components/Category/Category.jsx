...
import action from '../../Pictures/action.png'
import drama from '../../Pictures/drama.png'
import fantasy from '../../Pictures/fantasy.png'
import fiction from '../../Pictures/fiction.png'
import horror from '../../Pictures/horror.png'
import music from '../../Pictures/music.png'
import romance from '../../Pictures/romance.png'
import thriller from '../../Pictures/thriller.png'
import western from '../../Pictures/western.png'
...
const Block = ({data,idx, setCategories, categories})=>{
    ...
    return (
        <div data={data}  onClick={(e)=>handleClick(e)}  key={idx} 
            style={{background:data['color'],color:"white",padding:"16px",borderRadius:"12px",
